...
Map<String, dynamic> dataMapPrecisoTermohigrometro1Leitura = {
  ...
  'V.V.C 1 - Leitura 1': termohigrometroVCC1FormController,
  'V.V.C 2 - Leitura 1': termohigrometroVCC2FormController,
  'V.V.C 3 - Leitura 1': termohigrometroVCC3FormController,
  'V.V.C 4 - Leitura 1': termohigrometroVCC4FormController,
  'V.V.C 5 - Leitura 1': termohigrometroVCC5FormController,
...
Map<String, dynamic> dataMapPrecisoTermohigrometro2Leitura = {
  ...
  'Umidade Relativa: Final da Faixa de Uso': faixaEndURFormController.text,
  'Umidade Relativa: Valor de uma Divisão': divisaoURFormController.text,
  'V.V.C 1 - Leitura 1': termohigrometroVCC1FormController.text,
  'V.V.C 2 - Leitura 1': termohigrometroVCC2FormController.text,
  'V.V.C 3 - Leitura 1': termohigrometroVCC3FormController.text,
  'V.V.C 4 - Leitura 1': termohigrometroVCC4FormController.text,
  'V.V.C 5 - Leitura 1': termohigrometroVCC5FormController.text,
  'V.I.I 1 - Leitura 1 - Linha 1': termohigrometroR1VII1FormController.text,
  'V.I.I 2 - Leitura 1 - Linha 1': termohigrometroR1VII2FormController.text,
  'V.I.I 3 - Leitura 1 - Linha 1': termohigrometroR1VII3FormController.text,
  'V.I.I 1 - Leitura 1 - Linha 2': termohigrometroR2VII1FormController.text,
  'V.I.I 2 - Leitura 1 - Linha 2': termohigrometroR2VII2FormController.text,
  'V.I.I 3 - Leitura 1 - Linha 2': termohigrometroR2VII3FormController.text,
  'V.I.I 1 - Leitura 1 - Linha 3': termohigrometroR3VII1FormController.text,
  'V.I.I 2 - Leitura 1 - Linha 3': termohigrometroR3VII2FormController.text,
  'V.I.I 3 - Leitura 1 - Linha 3': termohigrometroR3VII3FormController.text,
  'V.I.I 1 - Leitura 1 - Linha 4': termohigrometroR4VII1FormController.text,
  'V.I.I 2 - Leitura 1 - Linha 4': termohigrometroR4VII2FormController.text,
  'V.I.I 3 - Leitura 1 - Linha 4': termohigrometroR4VII3FormController.text,
  'V.I.I 1 - Leitura 1 - Linha 5': termohigrometroR5VII1FormController.text,
  'V.I.I 2 - Leitura 1 - Linha 5': termohigrometroR5VII2FormController.text,
  'V.I.I 3 - Leitura 1 - Linha 5': termohigrometroR5VII3FormController.text,
  'V.V.C 1 - Leitura 2': termohigrometroA1VCC1FormController.text,
  'V.V.C 2 - Leitura 2': termohigrometroA1VCC2FormController.text,
  'V.V.C 3 - Leitura 2': termohigrometroA1VCC3FormController.text,
  'V.V.C 4 - Leitura 2': termohigrometroA1VCC4FormController.text,
  'V.V.C 5 - Leitura 2': termohigrometroA1VCC5FormController.text,
  'V.I.I 1 - Leitura 2 - Linha 1': termohigrometroA1R1VII1FormController.text,
  'V.I.I 2 - Leitura 2 - Linha 1': termohigrometroA1R1VII2FormController.text,
  'V.I.I 3 - Leitura 2 - Linha 1': termohigrometroA1R1VII3FormController.text,
  'V.I.I 1 - Leitura 2 - Linha 2': termohigrometroA1R2VII1FormController.text,
  'V.I.I 2 - Leitura 2 - Linha 2': termohigrometroA1R2VII2FormController.text,
  'V.I.I 3 - Leitura 2 - Linha 2': termohigrometroA1R2VII3FormController.text,
  'V.I.I 1 - Leitura 2 - Linha 3': termohigrometroA1R3VII1FormController.text,
  'V.I.I 2 - Leitura 2 - Linha 3': termohigrometroA1R3VII2FormController.text,
  'V.I.I 3 - Leitura 2 - Linha 3': termohigrometroA1R3VII3FormController.text,
  'V.I.I 1 - Leitura 2 - Linha 4': termohigrometroA1R4VII1FormController.text,
  'V.I.I 2 - Leitura 2 - Linha 4': termohigrometroA1R4VII2FormController.text,
  'V.I.I 3 - Leitura 2 - Linha 4': termohigrometroA1R4VII3FormController.text,
  'V.I.I 1 - Leitura 2 - Linha 5': termohigrometroA1R5VII1FormController.text,
  'V.I.I 2 - Leitura 2 - Linha 5': termohigrometroA1R5VII2FormController.text,
  'V.I.I 3 - Leitura 2 - Linha 5': termohigrometroA1R5VII3FormController.text,
};
...
Map<String, dynamic> dataMapPrecisoTermohigrometro3Leitura = {
  ...
  'V.I.I 2 - Leitura 2 - Linha 5': termohigrometroA1R5VII2FormController.text,
  'V.I.I 3 - Leitura 2 - Linha 5': termohigrometroA1R5VII3FormController.text,
  'V.V.C 1 - Leitura 3': termohigrometroA2VCC1FormController.text,
  'V.V.C 2 - Leitura 3': termohigrometroA2VCC2FormController.text,
  'V.V.C 3 - Leitura 3': termohigrometroA2VCC3FormController.text,
  'V.V.C 4 - Leitura 3': termohigrometroA2VCC4FormController.text,
  'V.V.C 5 - Leitura 3': termohigrometroA2VCC5FormController.text,
  'V.I.I 1 - Leitura 3 - Linha 1': termohigrometroA2R1VII1FormController.text,
  'V.I.I 2 - Leitura 3 - Linha 1': termohigrometroA2R1VII2FormController.text,
  'V.I.I 3 - Leitura 3 - Linha 1': termohigrometroA2R1VII3FormController.text,
  'V.I.I 1 - Leitura 3 - Linha 2': termohigrometroA2R2VII1FormController.text,
  'V.I.I 2 - Leitura 3 - Linha 2': termohigrometroA2R2VII2FormController.text,
  'V.I.I 3 - Leitura 3 - Linha 2': termohigrometroA2R2VII3FormController.text,
  'V.I.I 1 - Leitura 3 - Linha 3': termohigrometroA2R3VII1FormController.text,
  'V.I.I 2 - Leitura 3 - Linha 3': termohigrometroA2R3VII2FormController.text,
  'V.I.I 3 - Leitura 3 - Linha 3': termohigrometroA2R3VII3FormController.text,
  'V.I.I 1 - Leitura 3 - Linha 4': termohigrometroA2R4VII1FormController.text,
  'V.I.I 2 - Leitura 3 - Linha 4': termohigrometroA2R4VII2FormController.text,
  'V.I.I 3 - Leitura 3 - Linha 4': termohigrometroA2R4VII3FormController.text,
  'V.I.I 1 - Leitura 3 - Linha 5': termohigrometroA2R5VII1FormController.text,
  'V.I.I 2 - Leitura 3 - Linha 5': termohigrometroA2R5VII2FormController.text,
  'V.I.I 3 - Leitura 3 - Linha 5': termohigrometroA2R5VII3FormController.text,
};
